...
public class RobotContainer {
	...
	// Instantiate a ArmSubsystem object
	...
	private void configureBindings() {
		...
		// Set the motor speeds (once) to 0 and test the arm
		Commands.runOnce(()-> {
			m_ArmSubsystem.setArmMotorsSpeed(0);
		}).andThen(new TestArmCommand(m_ArmSubsystem));
	}
